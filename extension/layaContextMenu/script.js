(() => {
    ...
    class InfoBox extends ui.lobby.infoUI {
        ...
        _init() {
            ...
            this.root.getChildByName("loading").visible = false;
        ...
        show() {
            if (!this.locking && uiscript.UIBase) {
				let i = this;
				...
				this.x = 50 + 400 * (Laya.stage.width / Laya.stage.height / 1.777 - 1);
                uiscript.UIBase.anim_pop_out(this.root, Laya.Handler.create(this, function () {
                        i.locking = !0
                    }));
            }
        }
        close() {
			let i = this;
            uiscript.UIBase.anim_pop_hide(this.root, Laya.Handler.create(this, function () {
                    i.locking = !1
                }))
        }
    ...
    class Ball extends laya.ui.Label {
        ...
        _onclick(ball, event) {
			if (uiscript.UI_Lobby.Inst != null){
				if (!ball.infoui) {
