    ...
    class WQDY {
        ...
        _init() {
            ...
            uiscript.zhuangban.Container_Zhuangban = function (i, n, a) {
				...
				this.tab_index = -1,
				this.select_index = -1,
				this.cell_titles = [2193, 2194, 2195, 2214, 2624, 2856, 2412, 2413, 2826],
				this.cell_names = [411, 412, 413, 414, 415, 416, 0, 0, 0],
				this.cell_default_img = ["myres/sushe/slot_liqibang.jpg", "myres/sushe/slot_hule.jpg", "myres/sushe/slot_liqi.jpg", "myres/sushe/slot_hand.jpg", "myres/sushe/slot_liqibgm.jpg", "myres/sushe/slot_head_frame.jpg", "", "", ""],
				this.cell_default_item = [0, 0, 0, 0, 0, 305501, 305044, 305045, 307001],
				this.slot_map = {},
				this._changed = !1,
				this._locking = null,
				this._locking = a,
				...
				for (var s = this.container_zhuangban0.getChildByName("tabs"), o = function (e) {
					...
					i.clickHandler = new Laya.Handler(l, function () {
							r.locking || r.tab_index != e && (r._changed ? uiscript.UI_SecondConfirm.Inst.show(game.Tools.strOfLocalization(3022), Laya.Handler.create(r, function () {
										r.change_tab(e)
									}), null) : r.change_tab(e))
						})
				...
				this.btn_save.clickHandler = new Laya.Handler(this, function () {
						...
						var a = r.tab_index;
						if (uiscript.UI_Sushe.commonViewList.length < a)
							for (var s = uiscript.UI_Sushe.commonViewList.length; s <= a; s++)
								uiscript.UI_Sushe.commonViewList.push([]);
						if (uiscript.UI_Sushe.commonViewList[a] = e, uiscript.UI_Sushe.using_commonview_index == a && r.onChangeGameView(), r.tab_index != a)
							return;
